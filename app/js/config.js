...
catalogConfig.constant('CONFIG', {
	...
	vetementsSubcatsArray : ['veste', 'collant', 't-shirt', 'short', 'chaussette', 'pantalon', 'casquette'],
	chaussuresSubcatsArray : ['trail', 'piste', 'compétition', 'stable', 'nature'],
	accessoiresSubcatsArray : ['sac à dos', 'cardio', 'bouteille', 'gilet', 'sac'],
	pluralizeArray : ['veste', 'collant', 't-shirt', 'short', 'chaussette', 'pantalon', 'casquette', 'gilet', 'bouteille', 'sac'],
	pageSize : 75
})